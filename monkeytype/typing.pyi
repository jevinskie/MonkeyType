...
class GenericTypeRewriter(Generic[T], ABC):
    ...
    @property
    def registry(self) -> MappingProxyType[Any, Any]: ...
    @property
    def top(self) -> bool: ...
    @abstractmethod
    ...
    @abstractmethod
    def generic_rewrite(self, typ: type, caller: str | None = None) -> T: ...
    @abstractmethod
    ...
    def rewrite(self, typ: type, caller: str | None = None, top: bool = False) -> T: ...
...
class TypeRewriter(GenericTypeRewriter[type]):
    ...
    def generic_rewrite(self, typ: type, caller: str | None = None) -> type: ...
